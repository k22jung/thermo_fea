...
**ThermoFEA** is another small project I completed which utilizes a computer's GPU to parallelize computation for a large thermodynamic finite element analysis problem, consisting of thousands of nodes. 
